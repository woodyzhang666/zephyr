 ...
 */
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_PWM_CH32_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_PWM_CH32_H_
...
#define PWM_CH32_COMPLEMENTARY	(1U << 8)

/** @cond INTERNAL_HIDDEN */
#define PWM_CH32_COMPLEMENTARY_MASK	0x100
/** @endcond */
/** @} */

#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_PWM_CH32_H_ */
