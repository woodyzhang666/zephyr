...
extern struct dap_data dap_data;
extern volatile uint8_t dap_xfer_abort;
...
#endif
static ALWAYS_INLINE void PIN_DELAY_SLOW (uint32_t delay) {
...
#endif
static ALWAYS_INLINE void PIN_DELAY_FAST (void) {
